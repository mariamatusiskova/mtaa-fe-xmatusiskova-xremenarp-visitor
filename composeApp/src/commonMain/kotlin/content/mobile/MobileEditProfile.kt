...
@Composable
@Preview
fun loadMobileEditProfile(context: Any?) {
    ...
    Box(
        ...
        Column(
            ...
            DropdownMenu(
                ...
                modifier = Modifier
                    .background(if (navigationState.contrast) Color.Black else if (navigationState.darkmode) Color.DarkGray else Color.White)
            ) {
